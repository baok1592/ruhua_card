...
export default {  
	post(url, param) {  
		const res = this.uni_request(url,param,'post')  
		return res;
	},
	get(url, param) {
		const res = this.uni_request(url,param,'get') 
		return res;
	}, 
	put(url, param) {
		const res = this.uni_request(url,param,'put') 
		return res;
	}, 
	del(url, param) {
		const res = this.uni_request(url,param,'delete') 
		return res;
	}, 
